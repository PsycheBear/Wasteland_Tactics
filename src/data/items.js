// === ITEM SYSTEM ===
//
// All item icons render through GameIcon from `iconImg`. The legacy `icon`
...
export const COMPLETED_ITEMS = {
  power_armor: { name: 'Power Armor Frame', icon: '', iconImg: `${BASE}/images/icons/item-power-armor.svg`, recipe: ['scrap_metal', 'scrap_metal'], effects: { def: 40, damageReduction: 0.15 }, desc: '+40 DEF, 15% damage reduction' },
  ...
  rad_suit: { name: 'Rad Resistance Suit', icon: '', iconImg: `${BASE}/images/icons/item-rad-suit.svg`, recipe: ['stimpak', 'scrap_metal'], effects: { hp: 200, def: 20, poisonImmune: true }, desc: '+200 HP, +20 DEF, poison immune' },
  ...
  nuka_nuke: { name: 'Nuka-Nuke Launcher', icon: '', iconImg: `${BASE}/images/icons/item-nuka-nuke.svg`, recipe: ['nuka_quantum', 'nuka_quantum'], effects: { abilityPower: 0.45, burnOnAbility: 80 }, desc: '+45% ability power, ability burns for 80 dmg' },
  irradiated_blade: { name: 'Irradiated Blade', icon: '', iconImg: `${BASE}/images/icons/item-irradiated-blade.svg`, recipe: ['nuka_quantum', 'scrap_metal'], effects: { def: 15, abilityPower: 0.15, poisonOnHit: 30 }, desc: '+15 DEF, +15% ability power, attacks poison for 30 dmg' },
